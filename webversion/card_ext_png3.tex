...
\node [black,nodes={color=yellow!40!black}] at (recCen2) {
$\begin{tikzcd}[sep={between origins, \betweenpieces}]
  	\blocktwo{0} && \blocktwo{0} && \blocktwo{0} && \blocktwo{1} && \blocktwo{0} && \blocktwo{0} && \blocktwo{0} \\
  	\blocktwo{0} & \blocktwo{0} & \blocktwo{0} & \blocktwo{0} & \blocktwo{0} & \blocktwo{1} & \blocktwo{1} & \blocktwo{1} & \blocktwo{0} & \blocktwo{0} & \blocktwo{0} & \blocktwo{0} & \blocktwo{0} \\
  	\blocktwo{0} && \blocktwo{0} && \blocktwo{1} && \blocktwo{0} && \blocktwo{1} && \blocktwo{0} && \blocktwo{0}
