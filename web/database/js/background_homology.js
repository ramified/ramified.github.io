...
(function(root, factory) {
  ...
  function buildCellComplex(source) {
    ...
    // A zero-cell starts as a tile-local corner (T, v).  Two such corners
    // represent the same quotient vertex only when the equivalence can be
    // generated by crossing a real internal side or an explicit glued side.
    // Screen coordinates are deliberately irrelevant here: around a removed
    // tile or a cut, two disconnected vertex-star sectors can occupy the same
    // pixel without being the same point of the surface.
