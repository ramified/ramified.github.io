...
export async function renderAsset(asset, container, { mode = 'visual', edit } = {}) {
  ...
  switch (asset.type) {
    ...
    case 'points': container.append(pointsDiagram(a.points)); break;
    case 'cone': container.append(pointsDiagram(a.generators.map(g => g.coordinates))); break;
