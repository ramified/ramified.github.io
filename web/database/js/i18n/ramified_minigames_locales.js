(() => {
  ...
  const pairs = {
    ...
    'access.billiardsRules': ['Billiards rules', '拓扑台球规则'],
    'access.billiardsSetupTool': ['Billiards setup tool', '拓扑台球布置工具'],
    'access.billiardsBallPalette': ['Billiards ball palette', '拓扑台球球组选择板'],
    'access.billiardsAssistance': ['Billiards aim assistance', '拓扑台球瞄准辅助'],
    ...
    'games.billiards': ['Topological Billiards', '拓扑台球'],
    ...
    'io.recordsAvailable': ['Game records are available for Topological Billiards, Gomoku, Go, Connect Four, Reversi, and FIDE Chess.', '游戏记录支持拓扑台球、五子棋、围棋、四子棋、黑白棋和国际象棋。'],
