(() => {
  ...
  const pairs = {
    ...
    'controls.controlsTab': ['Controls', '键位'],
    'controls.displayTab': ['Display & sound', '显示与声音'],
    'controls.ui.settings': ['Controls', '键位设置'],
    'controls.ui.openSettings': ['Open control settings', '打开键位设置'],
    'controls.ui.close': ['Close', '关闭'],
    'controls.ui.keyboard': ['Keyboard shortcuts', '键盘快捷键'],
    'controls.ui.pointer': ['Mouse & touch hints', '鼠标与触控提示'],
    'controls.ui.restore': ['Restore defaults', '恢复默认键位'],
